...
const STAR_STYLES = [
  null, // index 0 unused
  { bg: 'bg-red-500/20', text: 'text-red-300', border: 'border-red-500/60' },
  { bg: 'bg-amber-500/20', text: 'text-amber-300', border: 'border-amber-500/60' },
  { bg: 'bg-blue-500/20', text: 'text-blue-300', border: 'border-blue-500/60' },
  { bg: 'bg-emerald-500/20', text: 'text-emerald-300', border: 'border-emerald-500/60' },
  { bg: 'bg-purple-500/20', text: 'text-purple-300', border: 'border-purple-500/60' },
];
...
<template>
  <div class="relative group/commit inline-flex items-center">
    <span
      class="inline-flex items-center gap-1 px-2 py-[5px] rounded-[3px] font-jetbrains text-base font-bold border leading-none"
    ...
    >
      <span class="tracking-tight">{{ commit.stars }}<span class="text-[1.25rem]/0 ">&starf;</span></span>
